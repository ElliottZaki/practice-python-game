...
class Player(pygame.sprite.Sprite):
  def __init__(self):
    ...
    self.surf = pygame.image.load("hacker.jpeg").convert()
...
while running:
    ...
    for event in pygame.event.get():
        ...
        # Add a new enemy?
          ...
          # Create new enemy and add it to lists
          new_enemy = Enemy()
    ...
    #     (SCREEN_HIGHT-player.surf.get_height())/2
    # )

    # # This line says "Draw surf(ace) onto the screen at the center"
